...
type AlertConfigurationsService interface {
	...
	List(context.Context, string, *atlas.ListOptions) ([]AlertConfiguration, *Response, error)
...
func (s *AlertConfigurationsServiceOp) List(ctx context.Context, groupID string, listOptions *atlas.ListOptions) ([]AlertConfiguration, *Response, error) {
	if groupID == "" {
		return nil, nil, atlas.NewArgError("groupID", "must be set")
	}
