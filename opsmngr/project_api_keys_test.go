...
func TestProjectAPIKeys_ListAPIKeys(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1.0/groups/1/apiKeys", func(w http.ResponseWriter, r *http.Request) {
...
func TestProjectAPIKeys_Unassign(t *testing.T) {
	...
	_, err := client.ProjectAPIKeys.Unassign(ctx, projectID, apiKeyID)
	if err != nil {
...
func TestProjectAPIKeys_Create(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/groups/%s/apiKeys", orgID), func(w http.ResponseWriter, r *http.Request) {
