...
func TestSyncStoreConfigServiceOp_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1.0/admin/backup/sync/mongoConfigs", func(w http.ResponseWriter, r *http.Request) {
...
func TestSyncStoreConfigServiceOp_Get(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/admin/backup/sync/mongoConfigs/%s", ID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		_, _ = fmt.Fprint(w, `{
					  "assignmentEnabled" : true,
					  "encryptedCredentials" : false,
...
func TestSyncStoreConfigServiceOp_Delete(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/admin/backup/sync/mongoConfigs/%s", ID), func(_ http.ResponseWriter, r *http.Request) {
