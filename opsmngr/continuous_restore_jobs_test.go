...
func TestContinuousBackupRestore_Get(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1.0/groups/5a66666887d9d61443b41645/clusters/Cluster0/restoreJobs/5a6669d9fcc178211a0d86b9", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
					  "batchId": "5a66783b80eef5354c77ee13",
...
func TestContinuousBackupRestore_Create(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1.0/groups/5a66666887d9d61443b41645/clusters/Cluster0/restoreJobs", func(w http.ResponseWriter, r *http.Request) {
