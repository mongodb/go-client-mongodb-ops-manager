...
func TestOrganizationWhitelistAPIKeys_List(t *testing.T) {
...
func TestOrganizationWhitelistAPIKeys_Get(t *testing.T) {
	client, mux, teardown := setup()
	defer teardown()
...
func TestOrganizationWhitelistAPIKeys_Create(t *testing.T) {
	client, mux, teardown := setup()
	defer teardown()
