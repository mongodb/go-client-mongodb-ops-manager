...
func TestTeams_List(t *testing.T) {
	...
	mux.HandleFunc("/api/public/v1.0/orgs/1/teams", func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
			"links": [{
				   "href": "https://cloud.mongodb.com/api/public/v1.0/orgs/7253g4s820thk69bfecd7bv1/teams?pageNum=1&itemsPerPage=100",
				   "rel": "self"
			}],
			"results": [{
...
func TestTeams_Get(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/orgs/%s/teams/%s", orgID, teamID), func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprint(w, `{
			...
			"links": [
				{
					"href": "https://cloud.mongodb.com/api/public/v1.0/orgs/1/teams/1",
					"rel": "self"
				}
			],
			"name": "myNewTeam"
...
func TestProject_GetTeamUsersAssigned(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/orgs/%s/teams/1/users", orgID), func(w http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodGet)
		fmt.Fprint(w, `{
			"links": [
				{
	...
	if err != nil {
		t.Fatalf("Teams.GetTeamUsersAssigned returned error: %v", err)
	}
...
func TestTeams_Create(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/orgs/%s/teams", orgID), func(w http.ResponseWriter, r *http.Request) {
...
func TestTeams_Rename(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/orgs/%s/teams/%s", orgID, teamID), func(w http.ResponseWriter, r *http.Request) {
		...
		jsonBlob := `
		{
			...
			"links" : [ {
			  "href" : "https://cloud.mongodb.com/api/public/v1.0/orgs/5991f2c580eef55aedbc6aa0/teams/6b720e1087d9d66b272f1c86",
			  "rel" : "self"
			} ],
			"name" : "newTeamName"
		}
...
func TestTeams_UpdateTeamRoles(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/groups/%s/teams/%s", orgID, teamID), func(w http.ResponseWriter, r *http.Request) {
		expected := map[string]interface{}{
...
func TestTeams_AddUsersToTeam(t *testing.T) {
	...
	mux.HandleFunc(fmt.Sprintf("/api/public/v1.0/orgs/%s/teams/%s/users", orgID, teamID), func(w http.ResponseWriter, r *http.Request) {
		expected := []map[string]interface{}{
			{
				"id": usersID[0],
			},
			...
			"results": [
				{
					...
					"links": [
						{
							"href": "https://cloud.mongodb.com/api/public/v1.0/users/1",
							"rel": "self"
						}
					],
